...
public class DubboEndpoint extends AbstractEndpoint<Map<String, Object>> {
  ...
  public Map<String, Object> getRuntime() {
    ...
    runtimeMap.put("protocol", this.dubboProperties.getDubboxDubbo().getProtocol());
    runtimeMap.put("port", this.dubboProperties.getDubboxDubbo().getPort());
    runtimeMap.put("threads", this.dubboProperties.getDubboxDubbo().getThreads());
